                                    ...
                                    <div class="bg-wrap" style="min-height: 765px;">
                                        ...
                                        <div class="order-progress">
                                            <ul>
                                                ...
                                                <li class="" :class="orderInfo.status>=3 ? 'active' : ''">
                                        ...
                                        <div class="form-box accept-box form-box1">
                                            <dl class="head form-group">
                                                <dd>
                                                    ...
                                                    <router-link v-if="orderInfo.status==1" :to="'/site/payOrder/' + orderInfo.id" class="btn-pay">去付款</router-link>
                                                    <!---->
                                                    <a v-if="orderInfo.status==3" @click="signed" href="javascript:void(0)" class="btn-pay">签收</a>
                                                </dd>
                                            </dl>
                                            <dl class="form-group">
                                                <dt>订单状态：</dt>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="5" class="ftable">
                                                <tbody>
                                                    ...
                                                    <tr v-for="item in goodsList" :key="item.id">
                                                        ...
                                                        <td align="left">
                                                            <a target="_blank" href="/goods/show-92.html">{{item.title}}</a>
                                                        </td>
                                                        <td align="center">
                                                    ...
                                                    <tr>
                                                        <td colspan="7" align="right">
                                                            <p>商品金额：
                                                                <b class="red">￥{{getGoodsAmount}}</b>&nbsp;&nbsp;+&nbsp;&nbsp;运费：
                                                                <b class="red">￥{{orderInfo.express_fee}}</b>
                                                            </p>
                                                            <p style="font-size: 22px;">应付总金额：
                                                                <b class="red">￥{{getGoodsAmount+orderInfo.express_fee}}</b>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
        ...
        computed:{
                ...
                getGoodsAmount(){
                    ...
                    this.goodsList.forEach(item=>{
                        goodsAmount+=item.real_price * item.quantity
                    })
